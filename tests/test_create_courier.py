...
class TestCreateCouriers:
    ...
    def test_create_courier_success(self, courier):
        ...
        assert new_courier["status_code"] == 201 and new_courier["response"] == Responses.NEW_COURIER_CREATE
    ...
    def test_create_couriers_with_same_name_error(self, courier):
        ...
        assert courier_with_same_name["status_code"] == 409 and courier_with_same_name["response"]["message"] == Responses.COURIER_CREATE_WITH_SAME_NAME
        login_courier = courier.login_courier(login_pass["login"], login_pass["password"])
        courier.delete_courier(login_courier["response"]["id"])
    ...
    def test_create_courier_without_login_error(self, courier):
        ...
        assert new_courier["status_code"] == 400 and new_courier["response"]["message"] == Responses.NEW_COURIER_ERROR_IN_DATA
